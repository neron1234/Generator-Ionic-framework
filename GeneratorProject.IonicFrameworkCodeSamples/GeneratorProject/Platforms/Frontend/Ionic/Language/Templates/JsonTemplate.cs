...
#line hidden
    ...
    { 
        ...
        if (_smartApp.SmallTitle != null)
        {
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(_smartApp.SmallTitle.ToPascalCase()));
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(_smartApp.Title.ToPascalCase()));
