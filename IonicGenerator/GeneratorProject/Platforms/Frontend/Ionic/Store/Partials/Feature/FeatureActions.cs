...
namespace GeneratorProject.Platforms.Frontend.Ionic
{
    public partial class FeatureActions: TemplateBase
    {
        ...
        public FeatureActions(SmartAppInfo smartApp, ApiInfo api, string apiSuffix, string viewModelSuffix) : base(smartApp)
        {
            _api = api;
        ...
        public override string OutputPath => "src\\app\\store\\" + _api.Id.ToCamelCase() + "\\" + "actions.ts";
    }
}
